<template>
			...
			<cl-table ref="Table">
				...
				<template #column-op="{ scope }">
					...
					<el-tooltip content="对领用单、资产清单进行修改" placement="top">
						...
						>
							<!-- 修改 -->
							<router-link :to="'/assets/immaterialAssetsReceive?id=' + scope.row.id">修改</router-link>
						</el-button>
					</el-tooltip>
	...
	<!-- 明细 -->
	<immateralReceiveCollect v-else-if="flag2" />
	<!-- 汇总 -->
	<immateralReceiveSummary v-else />
	<!-- 打印 -->
...
<script lang="ts" name="immateralReceiveDetails" setup>
import { useCrud, useTable } from '@cool-vue/crud'
import { useCool } from '/@/cool'
import { ref, reactive } from 'vue'
import dayjs from 'dayjs'
import { type TabsPaneContext } from 'element-plus'
import immateralReceiveCollect from './components/immateralReceiveCollect.vue'
import immateralReceiveSummary from './components/immateralReceiveSummary.vue'
...
const Crud = useCrud(
	{
		...
		dict: {
			api: {
				page: 'getImmaterialAssetsReceiveDocByPage',
			},
		},
