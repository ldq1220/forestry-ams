...
<template>
			...
			<cl-table ref="Table">
				...
				<template #column-op="{ scope }">
					...
					<el-tooltip content="对入库单、资产清单进行修改" placement="top">
						...
						>
							<!-- 修改 -->
							<router-link :to="'/assets/fixedPutStorage?id=' + scope.row.id">修改</router-link>
						</el-button>
					</el-tooltip>
	...
	<!-- 明细 -->
	<fixedAssetsWarehousingCollect v-else-if="flag2" />
	<!-- 汇总 -->
	<fixedAssetsPutStorageSummary v-else />
	<!-- 打印 -->
...
<script lang="ts" name="fixedAssetsPutStorageDocList" setup>
import { useCrud, useTable } from '@cool-vue/crud'
import { useCool } from '/@/cool'
import { ref, reactive } from 'vue'
import dayjs from 'dayjs'
import { type TabsPaneContext } from 'element-plus'
import fixedAssetsWarehousingCollect from './commponents/fixedAssetsWarehousingCollect.vue'
import fixedAssetsPutStorageSummary from './commponents/fixedAssetsPutStorageSummary.vue'
...
const Crud = useCrud(
	{
		...
		dict: {
			api: {
				page: 'getFixedAssetsPushStorageDocByPage',
			},
		},
