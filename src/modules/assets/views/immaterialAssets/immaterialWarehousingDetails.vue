<template>
			...
			<cl-table ref="Table">
				...
				<template #column-op="{ scope }">
					...
					<el-tooltip content="对入库单、资产清单进行修改" placement="top">
						...
						>
							<!-- 修改 -->
							<router-link :to="'/assets/immaterialPutStorage?id=' + scope.row.id">修改</router-link>
						</el-button>
					</el-tooltip>
	...
	<!-- 明细 -->
	<immaterialWarehousingCollect v-else-if="flag2" />
	<!-- 汇总 -->
	<immaterialAssetsPutStorageSummary v-else />
...
<script lang="ts" name="immaterialWarehousingDetails" setup>
import { useCrud, useTable } from '@cool-vue/crud'
import { useCool } from '/@/cool'
import { ref, reactive } from 'vue'
import dayjs from 'dayjs'
import { type TabsPaneContext } from 'element-plus'
import immaterialWarehousingCollect from './components/immaterialWarehousingCollect.vue'
import immaterialAssetsPutStorageSummary from './components/immaterialAssetsPutStorageSummary.vue'
...
const Crud = useCrud(
	{
		...
		dict: {
			api: {
				page: 'getImmaterialAssetsPushStorageDocByPage',
			},
		},
