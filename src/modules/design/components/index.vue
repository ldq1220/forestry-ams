						...
						>
							<template #item="{ element: item, index }">
								<div
									...
									@click="toDet(item)"
								>
									<el-icon class="close" @click.stop="remove(index)" v-show="form.active == item.id">
										<close-bold />
									</el-icon>

									<!-- 组合 -->
									<demo-group :data="item" v-bind="item.component.props" v-model:children="item.component.props.children" v-if="item.component.props.children" />

									<!-- 基础元素 -->
									<component :is="item.component.name" :data="item" v-bind="item.component.props" v-else />
								</div>
							</template>
