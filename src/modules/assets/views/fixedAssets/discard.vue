<template>
	...
	<div class="not_finished">
		...
		<el-tooltip content="对未“结束报废”的报废单、资产清单进行修改" placement="top">
			<el-select v-model="routeParamsLabel" filterable placeholder="对未结束的报废单进行修改" width="250" @change="selectIncompleteRecord">
	...
	<div class="form_box">
		...
		<el-form :model="docInfoForm" :inline="true">
			<el-row>
				<el-form-item label="报废人" required>
			...
			<el-table :data="goodsList" :stripe="true" style="width: 100%" @selection-change="handleSelectionChange" :border="true" :header-cell-style="{ backgroundColor: '#F5F5F5' }">
				...
				<el-table-column prop="field41" label="资产名称" header-align="center" align="center" />
				<el-table-column prop="field3" label="财厅编号" header-align="center" align="center" />
				<el-table-column prop="field78" label="规格型号" header-align="center" align="center" />
				<el-table-column prop="field23" label="报废数量" header-align="center" width="200" align="center">
					<template #default="scope">
						<el-input-number v-model="scope.row.goodsCnt" :min="1" placeholder="报废数量" disabled />
					</template>
				</el-table-column>
				<el-table-column prop="field32" label="存放地点" header-align="center" align="center" />
	...
	<cl-dialog v-model="addDialog" title="资产选择" center draggable width="950">
		...
		<cl-row>
			...
			>
				...
				<el-table-column prop="field41" label="资产名称" width="200" show-overflow-tooltip sortable align="left" />
				<el-table-column prop="customNo" label="资产编号" width="150" show-overflow-tooltip sortable align="left" />
				<el-table-column prop="field14" label="使用人" width="120" show-overflow-tooltip sortable align="center" />
				<el-table-column prop="field46" label="使用部门" width="120" show-overflow-tooltip sortable align="left" />
				<el-table-column prop="field78" label="规划型号" width="120" show-overflow-tooltip sortable align="left" />
				<el-table-column prop="field32" label="存放地点" width="120" sortable align="center" />
				<el-table-column prop="field5" label="取得日期" width="120" sortable align="center" />
				<el-table-column prop="field55" label="入库日期" width="120" show-overflow-tooltip sortable align="center" />
				<template #empty>
					<el-empty />
				</template>
			</el-table>
		...
		tableDataList = tableDataList.filter((item: any) => {
			...
			if (keyWord != null && keyWord != '') {
				...
				if (textType != null && textType == '资产编号') {
					...
					checkText = item['field78'] != null && item['field78'] != '' ? item['field78'] : ''
				} else if (textType != null && textType == '存放地点') {
					checkText = item['field32'] != null && item['field32'] != '' ? item['field32'] : ''
				} else {
					checkText = item['field41'] != null && item['field41'] != '' ? item['field41'] : ''
				}
			...
			if (dateType != null && dateType == '取得日期') {
				timeText = item['field5'] != null && item['field5'] != '' ? item['field5'] : ''
			} else {
			...
			if (deptName != null && deptName != '') {
				let checkText = item['field46'] != null && item['field46'] != '' ? item['field46'] : ''
			...
			if (userName != null && userName != '') {
				let checkText = item['field14'] != null && item['field14'] != '' ? item['field14'] : ''
